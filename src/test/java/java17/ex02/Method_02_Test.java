...
public class Method_02_Test {
    ...
    interface IDao {
        ...
        public default String format() {
            ...
            return String.format("[%d persons]", getClass().getSimpleName(), nbPersons);
        }
    }
    // end::IDao[]
    ...
    class DaoA implements IDao {
        ...
        public String format() {
            ...
            DaoA daoA = new DaoA();
            String chaine = daoA.format();
            //return (String.format("%s[%d persons]", getClass().getSimpleName(), nbPersons));
            return String.format("%s"+chaine, getClass().getSimpleName(), nbPersons);
        }
    }
    // end::DaoA[]
